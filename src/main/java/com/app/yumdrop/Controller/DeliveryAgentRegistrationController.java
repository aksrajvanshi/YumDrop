...
public class DeliveryAgentRegistrationController {
    ...
    public ResponseEntity<?> deliveryAgentRegistration(@RequestBody DeliveryAgentDetails deliveryAgentDetails) {
        ...
        boolean isSmsSent = smsTwoFactorService.send2FaCodeAsEmailDeliveryAgent(
                deliveryAgentDetails.getDeliveryAgent_email(), String.format("%06d", otpNumber));
    ...
    public ResponseEntity<?> verifyOTPandRegisterDeliveryAgent(
            @RequestBody DeliveryAgentRegisterForm deliveryAgentRegistrationForm) {

        DeliveryAgentOtp deliveryAgentOtp = deliveryAgentOtpRepository
                .findByDeliveryAgentEmail(deliveryAgentRegistrationForm.getDeliveryAgent_email());
        boolean checkOtpMatch = OtpUtils.checkIfDAOtpMatches(deliveryAgentRegistrationForm.getDeliveryAgent_otp(),
