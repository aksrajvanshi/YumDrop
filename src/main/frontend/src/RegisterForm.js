      ...
      <div className="App">
        <header>
          ...
          <nav className=" navbar navbar-expand-lg navbar-dark ">
            <div className="container">
              <a className="navbar-brand " onClick={this.goBackToHomePAge}>
                YumDrop
              </a>
              ...
              <div className="main">
                <div className="login-form">
                  <form>
                    ...
                    <div className="form-group">
                      <button
                        onClick={this.forwardToRestaurantRegistrationForm}
                        className="btn btn-primary btn-lg btn-block"
                      >
                        Restaurant
                      </button>
                    ...
                    <div className="form-group">
                      <button
                        type="submit"
                        onClick={this.forwardToDeliveryAgentRegistration}
                        className="btn btn-primary btn-lg btn-block"
                      >
                        Delivery Agent
                      </button>
                  ...
                  <form onSubmit={this.registerOtp.bind(this)}>
                    ...
                    <div className="form-group">
                      <input
                        ...
                        onChange={this.handleUserOtpChange}
                        type="text"
                        className="form-control"
                        placeholder="OTP"
                        pattern="[a-z][A-Z]"
                    ...
                    <div className="form-group">
                      <button
                        onClick={this.registerOtp.bind(this)}
                        type="submit"
                  ...
                  <form onSubmit={this.register.bind(this)}>
                    ...
                    <div className="social-btn text-center">
                      <FacebookLogin
                        ...
                        render={renderProps => (
                          ...
                          >
                            <i className="fa fa-facebook"></i> Sign up with{" "}
                            <b>Facebook</b>{" "}
                          </button>
                        )}
                      />
                    ...
                    <div className="form-group">
                      <input
                        ...
                        onChange={this.handleUserEmailIdChange}
                        type="text"
                        className="form-control"
        ...
        <div className="how-section1">
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <h4 className="subheading">
                Satisfy any craving with delivery from popular neighborhood
                restaurants and chains. Reorder go-tos or find something new.
              </h4>
            </div>
          </div>
          <div className="row">
            <div className="col-md-6">
              ...
              <h4 className="subheading">
                Get great food delivered or save time and money and preorder for
                pick up. Either way, order tracking and updates keep you in the
                know.
              </h4>
            </div>
            <div className="col-md-6 how-img">
              <img
                src="https://cdn.clipart.email/3a7d43627822f0b19af9bd540aebd827_food-delivery-man-clipart-clipartxtras_170-155.jpeg"
                className="rounded-circle img-fluid"
                alt=""
              />
            </div>
          ...
          <div className="row">
            <div className="col-md-6 how-img">
              <img
                src="https://activmeals.com/images/step3.png"
                className="rounded-circle img-fluid"
                alt=""
              />
            </div>
            <div className="col-md-6">
              ...
              <h4 className="subheading">
                ...
                crave, and order online or through the YumDrop app. Find great
                meals fast with lots of local menus. Enjoy eating the convenient
                way with places that deliver to your door..
              </h4>
            </div>
          </div>
          <div className="row">
            <div className="col-md-6">
              <h4>Easy Pay</h4>
              <h4 className="subheading">
                Pay for food with one click of a button. Multiple payment
                options.{" "}
              </h4>
            </div>
            <div className="col-md-6 how-img">
