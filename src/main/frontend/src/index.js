  ...
  <Provider store={store}>
    <Router>
      <div>
        ...
        <Route
          exact
          path="/ErrorPageForRestaurantRegistration"
          component={ErrorPageForRestaurantRegistration}
        />
        ...
        <Route
          exact
          path="/DeliveryAgentOTPpage"
          component={DeliveryAgentOTPpage}
        />
        <Route
          exact
          path="/errorPageForRegistration"
          component={errorPageForRegistration}
        />
        ...
        <Route
          ...
          component={DeliveryAgentRegistration}
        />
        <Route exact path="/RestaurantLogin" component={RestaurantLogin} />
        <Route
          exact
          path="/successfullyChangedPasswordPage"
          component={successfullyChangedPasswordPage}
        />
        <Route
          exact
          path="/UserSettingsPageAddresses"
          component={UserSettingsPageAddresses}
        />
        <Route
          exact
          path="/RestaurantAddMenuForm"
          component={RestaurantAddMenuForm}
        />
        <Route
          exact
          path="/RestaurantSettingsPage"
          component={RestaurantSettingsPage}
        />
        <Route
          exact
          path="/RestaurantResetpassword"
          component={RestaurantResetpassword}
        />
        <Route
          exact
          path="/restaurantAddressesPage"
          component={restaurantAddressesPage}
        />
        <Route
          exact
          path="/MyCurrentRestaurantLocation"
          component={MyCurrentRestaurantLocation}
        />
        <Route
          exact
          path="/ErrorPageForDeliveryAgentRegistration"
          component={ErrorPageForDeliveryAgentRegistration}
        />
        <Route
          exact
          path="/DeliveryAgentLoginForm"
          component={DeliveryAgentLoginForm}
        />
        <Route
          exact
          path="/DeliveryAgentLoginErrorPage"
          component={DeliveryAgentLoginErrorPage}
        />
        <Route
          exact
          path="/DeliveryAgentOTPResetPassword"
          component={DeliveryAgentOTPResetPassword}
        />
      </div>
    </Router>
  </Provider>
